        ...
        switch(command){
            ...
            case '!top5':
                ...
                case '!time':
                    if (!isGroupMsg) return await client.reply(chatId, msgs_texto.permissao.grupo, id)
                    var idParticipantesAtuais = await client.getGroupMembersId(groupId)
                    if(idParticipantesAtuais.length < 10) return await client.reply(chatId, msgs_texto.diversao.casal.minimoTime, id)
                    var indexAleatorio = Math.floor(Math.random() * idParticipantesAtuais.length)
                    var pessoaEscolhida1 = idParticipantesAtuais[indexAleatorio]
                    idParticipantesAtuais.splice(indexAleatorio,1)
                    indexAleatorio = Math.floor(Math.random() * idParticipantesAtuais.length)
                    ...
                    indexAleatorio = Math.floor(Math.random() * idParticipantesAtuais.length)
                    var pessoaEscolhida4 = idParticipantesAtuais[indexAleatorio]
                    indexAleatorio = Math.floor(Math.random() * idParticipantesAtuais.length)
                    var pessoaEscolhida5 = idParticipantesAtuais[indexAleatorio]
                    indexAleatorio = Math.floor(Math.random() * idParticipantesAtuais.length)
                    var pessoaEscolhida6 = idParticipantesAtuais[indexAleatorio]
                    indexAleatorio = Math.floor(Math.random() * idParticipantesAtuais.length)
                    var pessoaEscolhida7 = idParticipantesAtuais[indexAleatorio]
                    indexAleatorio = Math.floor(Math.random() * idParticipantesAtuais.length)
                    var pessoaEscolhida8 = idParticipantesAtuais[indexAleatorio]
                    indexAleatorio = Math.floor(Math.random() * idParticipantesAtuais.length)
                    var pessoaEscolhida9 = idParticipantesAtuais[indexAleatorio]
                    indexAleatorio = Math.floor(Math.random() * idParticipantesAtuais.length)
                    var pessoaEscolhida10 = idParticipantesAtuais[indexAleatorio]
                    var respostaTexto = criarTexto(msgs_texto.diversao.casal.respostaTime, pessoaEscolhida1.replace(/@c.us/g, ''), pessoaEscolhida2.replace(/@c.us/g, ''), pessoaEscolhida3.replace(/@c.us/g, ''), pessoaEscolhida4.replace(/@c.us/g, ''), pessoaEscolhida5.replace(/@c.us/g, ''), pessoaEscolhida6.replace(/@c.us/g, ''), pessoaEscolhida7.replace(/@c.us/g, ''), pessoaEscolhida8.replace(/@c.us/g, ''), pessoaEscolhida9.replace(/@c.us/g, ''), pessoaEscolhida10.replace(/@c.us/g, ''))
                    await client.sendTextWithMentions(chatId, respostaTexto)
                    break
